...
echo "[0/8] Init & start PostgreSQL..."
...
echo "[3/8] Start GlassFish domain..."
asadmin start-domain domain1

echo "[4/8] Set HTTP port (idempotent)..."
...
echo "[5/8] Configure JDBC pool/resource (idempotent)..."
POOL="LabPool"
JNDI="jdbc/LabDS"
